...
const contentData = {
    ...
    "Unité 1 : Les autres et moi": [
        {
            type: 'gallery',
            images: [
                { src: '/pic/img3e_unt1/s1.png', title: 'Séance 1' },
                { src: '/pic/img3e_unt1/s1-1.png', title: 'La suite de la séance 1' },
                { src: '/pic/img3e_unt1/s2-3.png', title: 'séance 2 et 3' }
            ],
            text: ''
        }
    ],
...
const defaultTitle = "Unité 1 : Les autres et moi";
